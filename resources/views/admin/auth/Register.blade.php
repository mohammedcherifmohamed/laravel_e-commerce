 ...
 <div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <form class="mt-8 space-y-6" id="loginForm">
                ...
                <div class="text-center">
                    <a href="../index.html" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                        ← Back to store
                    </a>
                </div>
            </form>
            ...
            <div class="mt-8 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                ...
                <p class="text-xs text-blue-800 dark:text-blue-200">Email: admin@luxecart.com</p>
                <p class="text-xs text-blue-800 dark:text-blue-200">Password: admin123</p>
            </div>
        </div>
    </div>
